...
<img src="./docs/images/seg_news_icon.png" width="50"/> *[2021-02-06] PaddleSeg has released the v2.0.0 version, which supports the dynamic graph by default. The static-graph codes have been moved to [legacy](./legacy). See detailed [release notes](./docs/release_notes.md).*
